...
public class House implements Serializable{
	...
	public House(boolean collected,double house_add_price,String house_address_city,
			double house_address_lat,double house_address_lng,String house_address_province,
			int house_assess_sum,String house_describe,int house_id,String house_limit_sex,
			int house_most_num,double house_one_price,int house_stay_time,String house_style,
			String house_title,String house_traffic,int user_id){
		super();
	...
	public House(int house_id, int user_id, String house_title,
			...
			int house_stay_time, int house_assess_sum, boolean collected) {
		super();
		this.house_id = house_id;
		this.user_id = user_id;
		this.house_title = house_title;
	...
	public String toString() {
		return "House [house_id=" + house_id + ", user_id=" + user_id
				+ ", house_title=" + house_title + ", house_describe="
				+ house_describe + ", house_style=" + house_style
				...
				+ ", house_traffic=" + house_traffic + ", house_most_num="
				+ house_most_num + ", house_one_price=" + house_one_price
				+ ", house_add_price=" + house_add_price + ", house_limit_sex="
				+ house_limit_sex + ", house_stay_time=" + house_stay_time
				+ ", house_assess_sum=" + house_assess_sum + ", collected="
				+ collected + "]";
	}
